...
load('BMD307Lab4Week2FullData.mat')
...
sound_reaction_time(2,:)=[];
light_reaction_time(1,:)=[];
light_reaction_time(2,:)=[];
...
title('Pilot Study: Reaction Time to a Visual Stimulus')
...
xlabel('Trial Number')
ylabel('Reaction Time (ms)')
title('Pilot Study: Reaction Time to an Auditory Stimulus')
legend('Subject 1','Subject 2','Subject 3')
ylim([0,750])

reaction_time_matrix=[light_reaction_time;sound_reaction_time];
[p,tbl]=anova2(reaction_time_matrix,35);
